...
[![NuGet version](https://img.shields.io/nuget/v/RA.Utilities.Api.Response.svg?logo=nuget)](https://www.nuget.org/packages/RA.Utilities.Api.Response/)
[![Codecov](https://codecov.io/github/RedonAlla/RA.Utilities/graph/badge.svg)](https://codecov.io/github/RedonAlla/RA.Utilities)
[![NuGet Downloads](https://img.shields.io/nuget/dt/RA.Utilities.Api.Response.svg)](https://www.nuget.org/packages/RA.Utilities.Api.Response/)
[![Documentation](https://img.shields.io/badge/Documentation-read-brightgreen.svg?logo=readthedocs&logoColor=fff)](https://redonalla.github.io/RA.Utilities/nuget-packages/api/RA.Utilities.Api.Response/)
...
`RA.Utilities.Api.Response` provides a standardized set of models for creating consistent API responses within the RA.Utilities ecosystem.
...
Package: RA.Utilities.Api.Response<br>
Source: [RA.Utilities.Api.Response](https://github.com/RedonAlla/RA.Utilities.git)
