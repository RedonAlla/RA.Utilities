...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ForbiddenResponse"/> class with a custom response code and message.
    /// </summary>
    /// <param name="responseCode">The response code.</param>
    /// <param name="responseMessage">The response message.</param>
    public ForbiddenResponse(int responseCode, string responseMessage)
    {
