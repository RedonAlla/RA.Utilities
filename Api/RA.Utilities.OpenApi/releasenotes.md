...
*   **Performance**: Optimized `TagOperationTransformer` to reduce allocations and handle empty tag lists efficiently.
*   **Documentation**: Added comprehensive XML documentation to the transformer and extension methods.
