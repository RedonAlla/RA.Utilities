...
To run the example project clone the [repository](https://github.com/RedonAlla/RA.CleanArchitecture.Template),
navigate to the `example` directory from the root of the repository and execute the application.
