...
### 5. [`PolymorphismSchemaFilter`](./PolymorphismSchemaFilter.md)
...
### 6. [`DefaultResponsesOperationTransformer`](./DefaultResponsesOperationTransformer.md)
An [`IOpenApiOperationTransformer`](https://learn.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.openapi.iopenapioperationtransformer) implementation that adds a default error response (500) to OpenAPI operations.
