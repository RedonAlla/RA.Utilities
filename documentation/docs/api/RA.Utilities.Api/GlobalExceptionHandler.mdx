...
If it's a known, semantic exception from your [`RA.Utilities.Core.Exceptions`](../../core/CoreExceptions/index.mdx) library
(like [`NotFoundException`](../../core/CoreExceptions/NotFoundException.md) or [`BadRequestException`](../../core/CoreExceptions/BadRequestException.md)),
