...
On failure, the filter returns an [**HTTP `400 Bad Request`**](../RA.Utilities.Api.Response/BadRequestResponse.md) with a structured JSON body containing the validation errors, providing a consistent and predictable error-handling experience for your API consumers.
