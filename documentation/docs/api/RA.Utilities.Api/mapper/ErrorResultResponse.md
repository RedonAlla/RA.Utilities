...
It is a key component for creating consistent error responses when using the [`Result<T>`](../RA.Utilities.Api.Response/index.mdx) pattern.

## 🎯 Purpose

When your application logic returns a [`Result<T>`](../RA.Utilities.Api.Response/index.mdx) that is in a `Failure` state, it contains an `Exception` object
...
| --- | --- | --- |
| `BadRequestException` | [`BadRequestResponse`](../RA.Utilities.Api.Response/BadRequestResponse.md) | 400 Bad Request |
| `UnauthorizedException` | [`UnauthorizedResponse`](../RA.Utilities.Api.Response/UnauthorizedResponse.md) | 401 Unauthorized |
| `ForbiddenException` | [`ForbiddenResponse`](../RA.Utilities.Api.Response/ForbiddenResponse.md) | 403 Forbidden |
| `NotFoundException` | [`NotFoundResponse`](../RA.Utilities.Api.Response/NotFoundResponse.md) | 404 Not Found |
| `ConflictException` | [`ConflictResponse`](../RA.Utilities.Api.Response/ConflictResponse.md) | 409 Conflict |
| `UnprocessableException` | [`UnprocessableResponse`](../RA.Utilities.Api.Response/UnprocessableResponse.md) | 422 Unprocessable Content |
| `TooManyRequestsException` | [`TooManyRequestsResponse`](../RA.Utilities.Api.Response/TooManyRequestsResponse.md) | 429 Too Many Requests |
| `ServiceUnavailableException` | [`ServiceUnavailableResponse`](../RA.Utilities.Api.Response/ServiceUnavailableResponse.md) | 503 Service Unavailable |
| `GatewayTimeoutException` | [`GatewayTimeoutResponse`](../RA.Utilities.Api.Response/GatewayTimeoutResponse.md) | 504 Gateway Timeout |
| Any other `RaBaseException` | [`ErrorResponse`](../RA.Utilities.Api.Response/ErrorResponse.md) | 500 Internal Server Error |
| Any other `Exception` | [`ErrorResponse`](../RA.Utilities.Api.Response/ErrorResponse.md) | 500 Internal Server Error |
...
The primary use case for `ErrorResultResponse` is within the `Match` method of a [`Result<T>`](../RA.Utilities.Api.Response/index.mdx) object. The `ErrorResultResponse.Result` method has the signature `Func<Exception, IResult>`, which perfectly matches the signature required by the `failure` delegate of `Match`.
