...
and map its properties to a corresponding response model (e.g., [`NotFoundResponse`](../Results/NotFoundResponse.md), [`ConflictResponse`](../Results/ConflictResponse.md)).
