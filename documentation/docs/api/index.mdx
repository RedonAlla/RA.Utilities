...
## `RA.Utilities.Api.Results` ⚠️ Deprecated
...
This section is kept for historical reference. New projects should use `RA.Utilities.Api` which now includes all response model types.
