...
[![Publish NuGet](https://github.com/RedonAlla/RA.Utilities/actions/workflows/publish-nuget.yml/badge.svg)](https://github.com/RedonAlla/RA.Utilities/actions/runs/19651255338)
...
The abstractions it provides are consumed by other packages, such as [`RA.Utilities.Data.Abstractions`](../Abstractions/index.mdx) and [`RA.Utilities.Data.EntityFramework`](../EntityFramework/index.mdx).
