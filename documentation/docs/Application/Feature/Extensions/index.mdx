...
```csharp showLineNumbers
_ = services
      .AddFeature<CreateProductCommand, Result<int>, CreateProductHandler>() // 1. Starts with the extension method
      .AddDecoration<LoggingBehavior<CreateProductCommand, Result<int>>>()   // 2. Chains a behavior from the returned builder
