...
It's a shared dependency for other packages like [`RA.Utilities.Api.Middlewares`](../../api/RA.Utilities.Api.Middlewares/index.mdx) (for logging incoming API requests) and
