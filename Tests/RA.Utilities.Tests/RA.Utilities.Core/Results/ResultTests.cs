...
public class ResultExtensionsTests
{
    ...
    /// </summary>
    [Fact(DisplayName = "Bind<TIn> with FailureResult<TIn> propagates exception")]
    ...
    /// <summary>
    /// Verifies that <see cref="ResultExtensions.Bind{TIn}(Result{TIn}, Func{TIn, Result})"/> throws an <see cref="ArgumentNullException"/>
    ...
    public void Bind_WithSuccessResultT_ReturnsNewResult()
    {
        ...
        // Act
        Result<string> returnedResult = result.Bind<int, string>(value => Result.Success(value.ToString(System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public void Bind_WithFailureResultT_PropagatesException()
    {
        ...
        // Act
        Result<string> returnedResult = result.Bind(value => Result.Success(value.ToString(System.Globalization.CultureInfo.InvariantCulture)));
    ...
    /// </summary>
    [Fact]
    public async Task OnSuccessAsync_WithNullAction_ThrowsNullReferenceException()
    {
        // Arrange
    ...
    /// </summary>
    [Fact]
    public async Task MapAsync_WithNullFunc_ThrowsNullReferenceException()
    {
        // Arrange
    ...
    #region Result<T> Implicit Operator Tests
