...
public interface IRequestHandler<TRequest, TResponse> where TRequest : IRequest<TResponse>
{
    ...
    Task<TResponse> HandleAsync<TContext>(TRequest request, PipelineContext<TContext> context, CancellationToken cancellationToken)
...
public interface IRequestHandler<in TRequest> where TRequest : IRequest
{
    ...
    /// </summary>
    /// <typeparam name="TContext">The user-defined context data type.</typeparam>
    Task HandleAsync<TContext>(TRequest request, PipelineContext<TContext> context, CancellationToken cancellationToken)
        where TContext : class, new()
        => HandleAsync(request, cancellationToken);
}
